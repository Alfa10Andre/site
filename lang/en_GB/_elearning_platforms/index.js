export default {
  ...
  totara_platforms: {
    ...
    text1: 'As Totara Gold Alliance Partner, EDUdigital has evolved the features of a tradional eLearning platform to an efficient and involving user experience, with better design, gamification and skills evaluation. You don’t need to worry about hosting, implementing, updates, training and continuous support, since we provide every service your organization needs',
